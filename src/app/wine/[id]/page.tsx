      ...
      <div className={styles["wine-box"]}>
        ...
        >
          <div className={styles["wine-details"]}>
            ...
            <p className={styles["description-indication"]}>
              {wine.description.indication}
            </p>
          </div>
        </div>
        ...
        <div className={styles["wine-checkout"]}>
          ...
          <div className={styles["quantity"]}>
            ...
            <Link href="/cart">
              <div className={styles["buy-btn-details"]} onClick={handleAddToCart}>
                Comprar
              </div>
            </Link>
          </div>
